...
export const EXERCISES_DB = [
  ...
  // --- GAMBE (LEGS) ---
  { id: 'l1', name: 'Squat con Bilanciere', category: EXERCISE_CATEGORIES.QUADRICEPS },
  { id: 'l2', name: 'Leg Press 45°', category: EXERCISE_CATEGORIES.QUADRICEPS },
  { id: 'l3', name: 'Affondi con Manubri', category: EXERCISE_CATEGORIES.QUADRICEPS },
  { id: 'l4', name: 'Leg Extension', category: EXERCISE_CATEGORIES.QUADRICEPS },
  { id: 'l5', name: 'Leg Curl', category: EXERCISE_CATEGORIES.HAMSTRINGS },
  { id: 'l6', name: 'Stacchi da Terra (Deadlift)', category: EXERCISE_CATEGORIES.HAMSTRINGS, secondaryCategories: [EXERCISE_CATEGORIES.BACK] },
  { id: 'l7', name: 'Stacchi Rumeni (RDL)', category: EXERCISE_CATEGORIES.HAMSTRINGS, secondaryCategories: [EXERCISE_CATEGORIES.BACK] },
  { id: 'l8', name: 'Calf Raise Seduto', category: EXERCISE_CATEGORIES.CALVES },
  { id: 'l9', name: 'Calf Raise in Piedi', category: EXERCISE_CATEGORIES.CALVES },
  { id: 'l10', name: 'Front Squat', category: EXERCISE_CATEGORIES.QUADRICEPS },
  { id: 'l11', name: 'Hack Squat', category: EXERCISE_CATEGORIES.QUADRICEPS },
  { id: 'l12', name: 'Bulgarian Split Squat', category: EXERCISE_CATEGORIES.QUADRICEPS },
  { id: 'l13', name: 'Hip Thrust', category: EXERCISE_CATEGORIES.GLUTES },
  { id: 'l14', name: 'Adductor Machine', category: EXERCISE_CATEGORIES.QUADRICEPS },
  { id: 'l15', name: 'Abductor Machine', category: EXERCISE_CATEGORIES.GLUTES },
  { id: 'l16', name: 'Pressa Orizzontale', category: EXERCISE_CATEGORIES.QUADRICEPS },
  { id: 'l17', name: 'Sissy Squat', category: EXERCISE_CATEGORIES.QUADRICEPS },
  { id: 'l18', name: 'Step Up', category: EXERCISE_CATEGORIES.QUADRICEPS },
  { id: 'l19', name: 'Good Morning', category: EXERCISE_CATEGORIES.HAMSTRINGS },
  { id: 'l20', name: 'Slanci ai Cavi', category: EXERCISE_CATEGORIES.GLUTES },
  // Integrazione Polpacci specifica
  { id: 'l21', name: 'Calf Raise alla Pressa', category: EXERCISE_CATEGORIES.CALVES },
  { id: 'l22', name: 'Donkey Calf Raise', category: EXERCISE_CATEGORIES.CALVES },
  { id: 'l23', name: 'Calf Raise su Gradino (Single Leg)', category: EXERCISE_CATEGORIES.CALVES },
  { id: 'l24', name: 'Tibiale Anteriore al Cavo/Macchina', category: EXERCISE_CATEGORIES.CALVES },
